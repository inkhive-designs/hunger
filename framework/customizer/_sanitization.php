...
/* Sanitization Functions Common to Multiple Settings go Here, Specific Sanitization Functions are defined along with add_setting() */
    function hunger_sanitize_checkbox( $input ) {
        if ( $input == 1 ) {
            return 1;
        } else {
            return '';
    ...
    function hunger_sanitize_positive_number( $input ) {
    ...
    function hunger_sanitize_category( $input ) {
    ...
    function hunger_sanitize_text( $input ) {
